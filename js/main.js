$(document).ready(function () {
  ...
  function t(a) {
    a.preventDefault(),
      e.removeClass("modal__overlay_active"),
      r.removeClass("modal__dialog_active");
  }
  a.on("click", function (a) {
    a.preventDefault(),
      e.addClass("modal__overlay_active"),
      r.addClass("modal__dialog_active");
  }),
    o.on("click", t),
    ...
    $(document).mouseup(function (e) {
      ...
      var modal = $(".modal__dialog"); // тут указываем ID элемента
      if (
